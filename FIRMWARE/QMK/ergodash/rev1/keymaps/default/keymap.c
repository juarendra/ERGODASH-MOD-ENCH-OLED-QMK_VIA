...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_C,             MO(_LOWER),   KC_A ,KC_DEL,         KC_BSPC,KC_B , MO(_RAISE),            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_C,             MO(_LOWER),   KC_SPC ,KC_DEL,         KC_BSPC,KC_ENT , MO(_RAISE),            KC_HOME, KC_PGDN, KC_PGUP, KC_END,
    KC_A, KC_B, KC_C, KC_D, KC_E, KC_F
  ),
